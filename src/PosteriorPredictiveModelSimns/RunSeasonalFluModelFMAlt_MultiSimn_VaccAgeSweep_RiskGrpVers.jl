...
#-------------------------------------------------------------------------------
function VaccUptake_ExpandSchoolAndElderly_RecovRisk(SeasonsToSimulate,JobIdx,VaccAgeBoundsData,SimnRunType)
...
###  VACCINATION UPTAKE
#--------------------------------------------------------------------------
VaccAgeBoundsData = readdlm("../NonInferenceVersion/VaccUptakeSweepFiles/VaccUptakeAgeSweep_BoundsData.txt",',')
...
include("../RecoverRiskVersion/RunSeasonalFluModelFMAlt_RecRiskFns_Julia.jl")
include("../../JuliaCrossModelFnFiles/ExpHistUpdateJulV1.jl")


#--------------------------------------------------------------------------
### Set ID for overall population data input file
#--------------------------------------------------------------------------
OverallPopnDataFileID = "VaccAgeSweepTestV2"
...
#----------------------------------------------------------------------
SaveFileID = "VaccAgeSweepTestV2"
if RiskGroupFlag == 0
	#OutputFName = "../../../../Results/FMAlt/FMAlt_InfluenzaCasePlots/FMAlt_SimnOutputFiles_Julia/FMAlt_SimnJuliaV1ModelRun_#$(SaveFileID)_LowRisk.mat"
	OutputFName = "C:/Users/edwar/Documents/GitHub/DoH-FluVaccine/Results/FMAlt/FMAlt_InfluenzaCasePlots/FMAlt_SimnOutputFiles_Julia/FMAlt_SimnJuliaV1ModelRun_#$(SaveFileID)_LowRisk.mat"
else RiskGroupFlag == 1
	#OutputFName = "../../../../Results/FMAlt/FMAlt_InfluenzaCasePlots/FMAlt_SimnOutputFiles_Julia/FMAlt_SimnJuliaV1ModelRun_#$(SaveFileID)_AtRisk.mat"
	OutputFName = "C:/Users/edwar/Documents/GitHub/DoH-FluVaccine/Results/FMAlt/FMAlt_InfluenzaCasePlots/FMAlt_SimnOutputFiles_Julia/FMAlt_SimnJuliaV1ModelRun_#$(SaveFileID)_AtRisk.mat"
end

#----------------------------------------------------------------------
### SPECIFY VACCINE UPTAKE FUNCTION NAME
#----------------------------------------------------------------------
VaccUptakeFunction = VaccUptake_ExpandSchoolAndElderly_RecovRisk

#--------------------------------------------------------------------------
#Call function to run multiple simulations
#--------------------------------------------------------------------------
JobNum = 820
TotalRunNumPerJob = 10

#Set up MAT file
OutputFile = matopen(OutputFName,"w")

#Loop over each job
for JobIdx = 820:JobNum

	#--------------------------------------------------------------------------
	### LOAD RELEVANT POPULATION LEVEL INFECTIOUS DATA
	MATfile = matopen("../../../../Results/FMAlt/FMAlt_InfluenzaCasePlots/FMAlt_SimnOutputFiles_Julia/FMAlt_SimnJuliaV1ModelRun_#$(OverallPopnDataFileID).mat")
